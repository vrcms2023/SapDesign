...
class ImageAndVideoGalleryAPIView(generics.CreateAPIView):
     ...
     queryset = imageAndVideoGallery.objects.all().order_by('news_position',"-created_at")
     ...
     def get(self, request, category, format=None):
        snippets = imageAndVideoGallery.objects.filter(category = category).order_by('news_position',"-created_at")
